...
public:
    ...
    public:
        ...
        SelectItem(ProcessGroupWorker* worker) : io::SelectItem(worker->GetWorkerFD()) {
            worker_ = worker;
        }
...
public:
    ProcessGroupWorker();
    ProcessGroupWorker(ProcessID& pid, sock::SockFD& worker_fd);
    ProcessGroupWorker(sock::SockAddress& worker_address);
    ~ProcessGroupWorker();
...
private:
    ProcessGroupWorker(ProcessGroupWorker& other);
    const ProcessGroupWorker& operator=(const ProcessGroupWorker& other);
