...
{
    this->s_address_ = SockAddress(family, port);
...
{
    this->s_address_ = SockAddress(family, address, port);
    if (!this->s_address_.AddrChecek()) {
        this->init_flag_ = false;
        return;
    }
...
{
    this->s_address_ = SockAddress(family, address);
    if (!this->s_address_.AddrChecek()) {
        this->init_flag_ = false;
        return;
    }
